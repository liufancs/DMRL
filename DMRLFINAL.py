...
class DMRL(object):
    ...
    def embedding_loss(self):
        ...
        for i in range(0, self.n_factors):
            weights = self._create_weight(i,user_factor_embedding_a[i], item_factor_embedding[i],
    ...
    def _create_weight(self,i,user,item,textual,visual):
    ...
    def item_scores(self):
        ...
        factor_ws = []
        for i in range(0, self.n_factors):
            weights = self._create_weight(i,user_expand_factor_embedding[i],item_expand_factor_embedding[i],textual_expand_factor_embedding[i],visual_expand_factor_embedding[i])
